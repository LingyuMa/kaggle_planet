...
NUM_RESIDUE_BLOCKS = 5
#WEIGHT_DECAY_FC = 0.0002
#WEIGHT_DECAY = 0.0002

WEIGHT_DECAY_FC = 0.0001
WEIGHT_DECAY = 0.0001

BATCH_SIZE = 128

INITIAL_LEARNING_RATE = 0.01
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = 33000
...
MAX_STEPS = 6000  # number of batches to run
...
NUM_EXAMPLES_PER_EPOCH_FOR_VALIDATION = 8000
EVALUATION_NUM_EXAMPLES = 8000
RUN_ONCE = False
